...
for ph,f in [('/*I18*/','src/02-i18n-generator.js'),('/*EXAM*/','src/03-exam-setup-cert.js'),('/*FIG*/','src/03b-question-figures.js'),
             ('/*CASES*/','src/05-mock-cases.js'),('/*SIMS*/','src/06-simulations-ar.js'),
             ('/*SIMSEN*/','src/07-simulations-en.js'),('/*TMPL*/','src/08-panel-templates.js'),
             ('/*TOOLS*/','src/09-tools-export.js'),('/*AGILE*/','src/07b-agile-hybrid.js'),('/*LIFE*/','src/10-lifecycle-data.js'),
             ('/*REPORT*/','src/09b-report-builder.js'),('/*LIFEUI*/','src/11-lifecycle-ui.js'),('/*ENGINE*/','src/12-engine.js'),
